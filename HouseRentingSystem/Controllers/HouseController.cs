...
namespace HouseRentingSystem.Controllers
{
    ...
    public class HouseController : Controller
    {
        ...
        public async Task<IActionResult> Mine()
        {
            ...
            {
                RedirectToAction("Mine", "House", new { area = AreaName});
            }
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            var categoryId = await houseService.GetHouseCategoryById(id);
        ...
        public async Task<IActionResult> Edit(int id, HouseModel model)
        {
            ...
            {
                ModelState.AddModelError("", "House does not exists");
                model.HouseCategories = await houseService.AllCategories();
        ...
        public async Task<IActionResult> Leave(int id)
        {
            ...
            if ((await houseService.IsRentedByUserId(id, User.Id())) == false)
            {
                return RedirectToPage("/Account/AccessDenied", new { area = "Identity" });
            }
